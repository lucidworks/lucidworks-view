(function () {
  angular.module('lucidworksView.components.document')
    .factory('DocumentConfig', function(){
       ...
       * If yes chosen template for that document will be `template_id`.
       *
       ...
       *
       * The template IDs will all be fetched from /client/components/document/<some-directory>/template_id.html
