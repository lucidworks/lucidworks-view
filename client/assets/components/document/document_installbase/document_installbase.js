(function () {
  angular.module('lucidworksView.components.document_installbase', ['lucidworksView.services.config',
      'lucidworksView.utils.docs', 'lucidworksView.services.signals'
    ])
    .directive('documentInstallbase', documentInstallbase);

  function documentInstallbase() {
    'ngInject';
    return {
