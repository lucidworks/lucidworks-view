(function () {
  angular.module('lucidworksView.components.document_RN_knowledge', ['lucidworksView.services.config',
      'lucidworksView.utils.docs', 'lucidworksView.services.signals'
    ])
      .directive('documentRightnowKnowledge', documentRightnowKnowledge);


  function documentRightnowKnowledge() {
    'ngInject';
    return {
      templateUrl: 'assets/components/document/document_rightnow_knowledge/document_rightnow_knowledge.html',
      scope: true,
