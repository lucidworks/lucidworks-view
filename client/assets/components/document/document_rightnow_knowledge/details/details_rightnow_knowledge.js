(function () {
  angular.module('lucidworksView.components.details_RN_knowledge', ['lucidworksView.services.config',
      'lucidworksView.utils.docs', 'lucidworksView.services.signals'
    ])
    .directive('detailsRNKnowledge', detailsRNKnowledge);

  function detailsRNKnowledge() {
    'ngInject';
    return {
      //templateUrl: 'assets/components/document/document_RN_knowledge/document_RN_knowledge.html',
      templateUrl: 'assets/components/document/document_rightnow_knowledge/details/details_rightnow_knowledge.html',
      scope: true,
