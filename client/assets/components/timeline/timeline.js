(function () {
  ...
  angular
      .module('lucidworksView.components.timeline', ['lucidworksView.services.config',
        'ngOrwell',
      ])
  ...
  function Controller($sce, $anchorScroll, Orwell, QueryService, $log, $scope, URLService, QueryDataService, ConfigService) {
    'ngInject';
    var vm = this; 
